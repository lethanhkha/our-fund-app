        ...
        <div className="font-sans antialiased max-w-md mx-auto min-h-screen bg-[#FDF2F8] flex flex-col relative overflow-x-hidden">
            ...
            <main className="flex-grow flex flex-col px-6">
                ...
                <div className="flex flex-col items-center justify-center py-6">
                    <button className="w-32 h-32 rounded-[2rem] border-2 border-dashed border-pink-200 bg-[var(--color-brand-secondary)] flex flex-col items-center justify-center text-[#EC4899] gap-2 hover:bg-pink-100 transition-colors">
