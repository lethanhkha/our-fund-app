        ...
        <div className="font-sans antialiased max-w-md mx-auto min-h-screen bg-white flex flex-col relative overflow-x-hidden">
            ...
            <main className="px-6 py-6 flex-grow flex flex-col">
                ...
                <div className="mb-auto space-y-4">
                    {/* DATE INPUT */}
                    <div className="flex items-center bg-gray-50 rounded-[1.5rem] p-4 border border-gray-100 focus-within:border-pink-200 focus-within:bg-[#FDF2F8] transition-colors">
